...
var path_1 = __importDefault(require("path")); //路径
var superagent_1 = __importDefault(require("superagent")); //安装之后引入会报错，缺少.d.ts文件，执行npm install @types/superagent -D,其他类似
var analyzer_1 = __importDefault(require("./analyzer")); //分析器
...
//要爬取的网址
var url = "http://www.xuyang.run/blog";
//分析器对象，单例模式
var analyzer = analyzer_1.default.getInstace();
//爬虫对象
